(() => {
  ...
  function diagnosticProfessorName(student = {}) {
    ...
    return semProfessor ? "Sem professor de apoio" : raw;
  }
  ...
  function groupInclusiveStudentsBySeries(students = []) {
    const sorted = [...students].sort((a, b) => {
      ...
      return String(a.nome_aluno || "").localeCompare(
        String(b.nome_aluno || ""),
        "pt-BR",
        { sensitivity: "base" }
      );
    ...
    elements.diagnosticContent.innerHTML = `
      ...
      <section class="diagnostic-section students-section support-section">
        <div class="diagnostic-section-heading">
          ...
          <h3>Alunos com professor de apoio</h3>
          <p>
            Organizados por ano/série e, dentro de cada série, pelo professor responsável.
            Nos Anos Iniciais, a sequência começa pelo 1º Ano Fundamental e segue até o 5º Ano.
          </p>
        </div>
      ...
      <section class="diagnostic-section inclusive-education-section">
        <div class="inclusive-section-heading">
          <div>
            ...
            <h3>Alunos sem professor de apoio</h3>
            <p>
              Organizados por Anos Iniciais, em ordem crescente:
              1º, 2º, 3º, 4º e 5º Ano Fundamental. Dentro de cada ano, os alunos ficam em ordem alfabética.
            </p>
          </div>
