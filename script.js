(() => {
  ...
  /*
   * SUPABASE
   * Mantenha aqui a Project URL e a chave publishable (sb_publishable_...).
   * Nunca coloque uma chave sb_secret_ ou service_role neste arquivo.
   */
  ...
  async function handleLogin(event) {
    ...
    try {
      ...
      console.error(error);
      showLoginError("Usuário ou senha inválidos, ou acesso ainda não autorizado.");
    } finally {
