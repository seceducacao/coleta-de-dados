  ...
  function renderDiagnostic(data) {
    ...
    elements.diagnosticContent.innerHTML = `
      ...
      <section class="diagnostic-metrics">
        ...
        ${diagnosticMetric("Com professor de Educação Especial", Number(summary.com_professor_ee || 0))}
      </section>
      ...
      <section class="diagnostic-section students-section">
        <div class="diagnostic-section-heading">
          ...
          <h3>Relação individual</h3>
          <p>Os campos abaixo seguem a estrutura definida para o diagnóstico.</p>
        </div>
        ...
        <div class="diagnostic-table-wrap">
          <table class="diagnostic-table">
            ...
            <tbody>
              ${studentRows || '<tr><td colspan="9" class="diagnostic-empty-cell">Nenhum estudante registrado.</td></tr>'}
            </tbody>
          </table>
        </div>
      </section>
